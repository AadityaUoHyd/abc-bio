...
![Portfolio Screenshot](https://raw.githubusercontent.com/AadityaUoHyd/abc-bio/refs/heads/main/screenshot.png)
...
2. Connect repo to [github](https://AadityaUoHyd.github.io/abc-bio/).
3. Set build command: (none) and publish directory: `/`.
4. Deploy! Get a custom URL like `your-portfolio.netlify.app` or `https://AadityaUoHyd.github.io/abc-bio/` in github page.
...
https://AadityaUoHyd.github.io/abc-bio/
